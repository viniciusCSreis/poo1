 ...
 * @author vinic
 */
public class ListarCursoPosGraduacao extends javax.swing.JFrame {

    /**
     * Creates new form ListarCursoPosGraduacao
     */
    public ListarCursoPosGraduacao() {
        initComponents();
        listar();
    }
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if(index>-1)
        {
            ...
            CursoPosGraduacao c     =   DadosCursoPosGraduacao.getDados().get(index);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(DadosCursoPosGraduacao.excluir(jTable1.getSelectedRow()))
        {
            listar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarCursoPosGraduacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarCursoPosGraduacao().setVisible(true);
            }
        });
    }
    ...
    public void listar()
    {
        ...
        for (CursoPosGraduacao a : DadosCursoPosGraduacao.getDados() )
        {
            String situacao="";
